...
class cat_format(object):
    def __init__(self, tycho_only=True):
        if tycho_only:
            self.catformat = dict(id=dict(col=0, type='string', width=6),
                                  ra=dict(col=1, type='float', width=11),
                                  dec=dict(col=2, type='float', width=11),
                                  plx =dict(col=3, type='float', width=7),
                                  eplx =dict(col=4, type='float', width=6),
                                  BV=dict(col=5, type='float', width=8),
                                  BT=dict(col=6, type='float', width=7),
                                  eBT=dict(col=7, type='float', width=7),
                                  VT=dict(col=8, type='float', width=7),
                                  eVT=dict(col=9, type='float', width=7),
                                  vsini=dict(col=10, type='float', width=8),
                                  evsini=dict(col=11, type='float', width=7))
        else:
